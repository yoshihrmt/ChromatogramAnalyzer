...
if uploaded_files and file_info_list:
    with st.sidebar:
        ...
        font_xlabel = st.slider("x軸ラベルフォント", 10, 30, 19.5, 0.05, key="font_xlabel")
        font_ylabel = st.slider("y軸ラベルフォント", 10, 30, 19.5, 0.05, key="font_ylabel")
        font_legend = st.slider("凡例フォント", 5, 22, 13, 0.05, key="font_legend")
        font_tick = st.slider("x軸値フォント", 5, 18, 11, 0.05, key="font_tick")
        font_scale_value = st.slider("スケールバー値フォント", 10, 26, 17.5, 0.05, key="font_scale_value")
