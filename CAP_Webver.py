...
if uploaded_files and file_info_list:
    with st.sidebar:
        ...
        font_xlabel = st.slider("x軸ラベルフォント", 10, 36, 23, key="font_xlabel")
        font_ylabel = st.slider("y軸ラベルフォント", 10, 36, 23, key="font_ylabel")
        font_legend = st.slider("凡例フォント", 5, 25, 15, key="font_legend")
